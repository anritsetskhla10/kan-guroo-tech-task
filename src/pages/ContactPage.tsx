...
const ContactPage = () => {
  ...
  return (
    <>
      ...
      {/* მთავარი კონტენტი */}
      <section className="py-16 md:py-24 px-4 bg-white dark:bg-primary-light">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <motion.div 
            ...
            className="lg:col-span-2 bg-primary-mintgreen dark:bg-secondary p-8 rounded-2xl text-black dark:text-white shadow-lg"
          >
            <h2 className="text-3xl font-bold  mb-2">{t('contactPage.form.title')}</h2>
            <p className="mb-8">
            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              >
                <motion.div variants={fadeInUp}>
                  <label htmlFor="from_name" className="block text-sm font-medium  mb-1">{t('contactPage.form.nameLabel')}</label>
                ...
                <motion.div variants={fadeInUp}>
                  <label htmlFor="from_email" className="block text-sm font-medium  mb-1">{t('contactPage.form.emailLabel')}</label>
                ...
                <motion.div variants={fadeInUp}>
                  <label htmlFor="from_phone" className="block text-sm font-medium  mb-1">{t('contactPage.form.phoneLabel')}</label>
                ...
                <motion.div variants={fadeInUp}>
                  <label htmlFor="message" className="block text-sm font-medium  mb-1">{t('contactPage.form.messageLabel')}</label>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, ease: 'easeOut' }}
            className="bg-primary-mintgreen dark:bg-secondary p-8 rounded-2xl text-black dark:text-white"
          >
            ...
            >
              <motion.div variants={fadeInUp} className="flex items-center">
                <FiPhone className="dark:text-text-yellow text-primary-darkest text-2xl mr-4"/>
                <div>
                  <h4 className="font-semibold dark:text-text-yellow dark:hover:text-text-lightYellow text-primary-darkest">{t('contactPage.info.phoneTitle')}</h4>
                  <a href="tel:+995577302525" className="dark:text-text-yellow text-primary-darkest hover:underline">+995 577 30 25 25</a>
                </div>
              </motion.div>
              <motion.div variants={fadeInUp} className="flex items-center">
                <FiMail className="dark:text-text-yellow text-primary-darkest text-2xl mr-4"/>
                <div>
                  <h4 className="font-semibold dark:text-text-yellow dark:hover:text-text-lightYellow text-primary-darkest">{t('contactPage.info.emailTitle')}</h4>
                  <a href="mailto:info@kan-guroo.com" className="dark:text-text-yellow text-primary-darkest hover:underline">info@kan-guroo.com</a>
                </div>
              </motion.div>
              <motion.div variants={fadeInUp} className="flex items-center">
                <FiCalendar className="dark:text-text-yellow text-primary-darkest text-2xl mr-4"/>
                <div>
                  <h4 className="font-semibold dark:text-text-yellow dark:hover:text-text-lightYellow text-primary-darkest">{t('contactPage.info.consultationTitle')}</h4>
                  <a href='https://calendly.com/kan-guroo/15min?month=2025-09' className="dark:text-text-yellow text-primary-darkest hover:underline">{t('contactPage.info.consultationText')}</a>
                </div>
              </motion.div>
            </motion.div>
